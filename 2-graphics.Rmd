...
```{r graphics1, fig.width=6, fig.height=6, out.width="35%"}
...
```{r graphics2, fig.height=4, fig.width=10}
holidays |>
...
```{r tourismacf2, fig.height=5, fig.width=5, out.width="40%"}
holidays |>
  ACF(Trips) |>
  autoplot()
```
...
```{r, fig.height=6, fig.width=12, echo=FALSE, warning=FALSE, out.width="15.5cm"}
